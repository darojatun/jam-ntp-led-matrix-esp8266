...
// Credentials ----------------------------------------
const char* SSID = "Djatun-HotSpot";      // "mySSID";
...
#define TZName     "WIT-7"                     // Jakarta

// User defined text ----------------------------------
#define UDTXT        "        » CV. Ðjâtúñ Cömpΰtér «       "
...
const char* NTP_SERVER[] = {"jam.bmkg.go.id", "id.pool.ntp.org", "asia.pool.ntp.org"};

// The object for the Ticker
Ticker tckr;

String M_arr[12] = {"Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"};
String WD_arr[7] = {"Ahad,", "Senin,", "Selasa,", "Rabu,", "Kamis,", "Jum´at,", "Sabtu,"};
